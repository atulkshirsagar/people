define('appkit/templates/application', ['exports'], function(__exports__){ __exports__['default'] = Ember.Handlebars.compile("<h2 id='title'>People List</h2>\n\n{{outlet}}\n"); });
